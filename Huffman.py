...
def EncodeToHuffman(Plaintext:bytes):
    ...
    #print("Decoded Output Base64", HuffmanDecoding(encoding, the_tree))  
def DecodeFromHuffman(CompressedString:str,Tree):
    Decompressed=base64.b64decode(HuffmanDecoding(CompressedString, Tree))
